...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/grafele/PullToReach'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'grafele' => 'stefan.kofler@quickbirdstudios.com' }
  s.source           = { :git => 'https://github.com/grafele/PullToReach.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'PullToReach' => ['PullToReach/Assets/*.png']
  # }
